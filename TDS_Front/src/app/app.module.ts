...
import { EntregasComponent as EntregasUserTareas } from './Maestros/entregas/entregas.component';
...
import { EntregasComponent as EstudiantesUserEntregas } from './Estudiantes/entregas/entregas.component';
...
import { EntregasComponent } from './Maestros/entregas/entregas.component';
...
const routes: Routes = [
  ...
  { path: "maestroUser/clases/entregas/:id/:idTarea", component: EntregasUserTareas, canActivate: [UserLogin] },
  ...
  { path: "estudianteUser/entregas", component: EstudiantesUserEntregas, canActivate: [UserLogin] },
  { path: "estudianteUser/entregas/:id", component: EstudiantesUserEntregas, canActivate: [UserLogin] },
